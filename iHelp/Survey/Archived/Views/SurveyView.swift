        ...
        VStack {
            ...
            Button(action: { selectChoice(choice) }, label: {
                ...
                Text( choice.text )
                    ...
                    .foregroundColor( choice.selected ? Color.black : Color.gray )
    ...
    var body: some View {
        ...
        if surveyState == .showingIntroScreen {
            ...
            VStack {
                ...
                Image("Conversation").resizable()
                    .scaledToFit()
                    .frame(width: 200, height: 200)
                    .padding(EdgeInsets(top: 20, leading: 0, bottom: 16, trailing: 0))
                
                Text("Your opinion in only 2 minutes.").font(.title)
                    .foregroundColor(Color.orange.opacity(0.8))
                    .multilineTextAlignment(.center)
                    .padding(EdgeInsets(top: 16, leading: 16, bottom: 16, trailing: 16))
                
                Text("By answering a few questions, you help us understand your child's needs and improve our service for an even better experience.")
                    .font(.system(size: 15, weight: .regular))
                    .padding(EdgeInsets(top: 0, leading: 16, bottom: 10, trailing: 16)).multilineTextAlignment(.center)
                ...
                HStack {
                    ...
                    Button(action: { self.takeSurveyTapped() }, label: {
                        Text("Take the Survey")
                            .font(.system(size: 15, weight: .semibold))
                            .padding(6.0)
                    }).buttonStyle(CustomButtonStyle(bgColor: Color("primary")))
                        .padding(5)
            ...
            VStack {
                ...
                Button(action: { submitSurveyTapped() }, label: {
                    Text("Submit Survey")
                        .font(.system(size: 15, weight: .semibold))
                        .padding(6.0)
                }).buttonStyle(CustomButtonStyle(bgColor: Color("primary"))).padding()
