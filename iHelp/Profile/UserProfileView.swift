            ...
            VStack {
                ...
                Form {
                    Section(header: Text("Personal Information")) {
                        LabelValueRow(label: "User Type", value: user.role.name)
                        ...
                        /*if isEditMode {
                            LabelInputRow(label: "User Name", value: $userProfile.username)
                    ...
                    Section(header: Text("Address")) {
                        ...
                        LabelValueRow(label: "Street", value: "N/A")
                        LabelValueRow(label: "City", value: "N/A")
                        LabelValueRow(label: "State", value: "N/A")
                        LabelValueRow(label: "Postal Code", value: "N/A")
                        LabelValueRow(label: "Country", value: "N/A")
...
struct UserProfileView_Previews: PreviewProvider {
    static var previews: some View {
        let user = User(id: 1, fullName: "", firstName: "", lastName: "", roleID: 1, status: 1, email: "fdfdf@mgail.com", createdAt: "", updatedAt: "", role: UserRole(id: 1, name: "Patient", guardName: "", createdAt: "", updatedAt: ""))
